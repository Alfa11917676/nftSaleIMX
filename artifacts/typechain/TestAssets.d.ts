...
interface TestAssetsInterface extends ethers.utils.Interface {
  functions: {
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "baseURI()": FunctionFragment;
    "encodedWithTokenId(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "encodedWithTokenId",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export class TestAssets extends BaseContract {
  ...
  callStatic: {
    ...
    resume(overrides?: CallOverrides): Promise<boolean>;
